...
export declare const filterByPath: <T extends Pick<NavigationItemDTO, "documentId" | "path" | "parent">>(items: T[], path?: string) => {
    root?: NestedPath;
    items: T[];
};
export declare const buildNestedPaths: <T extends Pick<NavigationItemDTO, "documentId" | "path" | "parent">>(items: T[], documentId?: string, parentPath?: string | null) => NestedPath[];
